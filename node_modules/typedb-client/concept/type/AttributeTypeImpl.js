...
class AttributeTypeImpl extends dependencies_internal_1.ThingTypeImpl {
    constructor(name, root, abstract) {
    ...
    asRemote(transaction) {
        return new AttributeTypeImpl.Remote(transaction, this.label, this.root, this.abstract);
    }
    get valueType() {
...
(function (AttributeTypeImpl) {
    ...
    class Remote extends dependencies_internal_1.ThingTypeImpl.Remote {
        constructor(transaction, label, root, abstract) {
    ...
    class Boolean extends AttributeTypeImpl {
        constructor(label, root, abstract) {
        ...
        asRemote(transaction) {
            return new AttributeTypeImpl.Boolean.Remote(transaction, this.label, this.root, this.abstract);
        }
        get valueType() {
    ...
    class Long extends AttributeTypeImpl {
        ...
        asRemote(transaction) {
            return new AttributeTypeImpl.Long.Remote(transaction, this.label, this.root, this.abstract);
        }
        get valueType() {
    ...
    class Double extends AttributeTypeImpl {
        ...
        asRemote(transaction) {
            return new AttributeTypeImpl.Double.Remote(transaction, this.label, this.root, this.abstract);
        }
        get valueType() {
    ...
    class String extends AttributeTypeImpl {
        ...
        asRemote(transaction) {
            return new AttributeTypeImpl.String.Remote(transaction, this.label, this.root, this.abstract);
        }
        get valueType() {
    ...
    class DateTime extends AttributeTypeImpl {
        ...
        asRemote(transaction) {
            return new AttributeTypeImpl.DateTime.Remote(transaction, this.label, this.root, this.abstract);
        }
        get valueType() {
