...
export declare namespace RequestBuilder {
    ...
    namespace Cluster {
        ...
        namespace UserManager {
            ...
            function deleteReq(name: string): ClusterUserManagerProto.Delete.Req;
            function allReq(): ClusterUserManagerProto.All.Req;
            function passwordSetReq(name: string, password: string): ClusterUserManagerProto.PasswordSet.Req;
            function getReq(name: string): ClusterUserManagerProto.Get.Req;
        }
        namespace User {
            function passwordUpdateReq(name: string, passwordOld: string, passwordNew: string): ClusterUserProto.PasswordUpdate.Req;
    ...
    namespace Type {
        ...
        namespace RoleType {
            ...
            function getPlayerTypesReq(label: Label): TransactionProto.Req;
            function getPlayerTypesExplicitReq(label: Label): TransactionProto.Req;
            function getRelationInstancesReq(label: Label): TransactionProto.Req;
            function getRelationInstancesExplicitReq(label: Label): TransactionProto.Req;
            function getPlayerInstancesReq(label: Label): TransactionProto.Req;
            function getPlayerInstancesExplicitReq(label: Label): TransactionProto.Req;
        }
        namespace ThingType {
            ...
            function getSyntaxReq(label: Label): TransactionProto.Req;
        }
