...
function serialize_typedb_protocol_ClusterUser_PasswordUpdate_Req(arg) {
  if (!(arg instanceof cluster_cluster_user_pb.ClusterUser.PasswordUpdate.Req)) {
    throw new Error('Expected argument of type typedb.protocol.ClusterUser.PasswordUpdate.Req');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_typedb_protocol_ClusterUser_PasswordUpdate_Req(buffer_arg) {
  return cluster_cluster_user_pb.ClusterUser.PasswordUpdate.Req.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_typedb_protocol_ClusterUser_PasswordUpdate_Res(arg) {
  if (!(arg instanceof cluster_cluster_user_pb.ClusterUser.PasswordUpdate.Res)) {
    throw new Error('Expected argument of type typedb.protocol.ClusterUser.PasswordUpdate.Res');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_typedb_protocol_ClusterUser_PasswordUpdate_Res(buffer_arg) {
  return cluster_cluster_user_pb.ClusterUser.PasswordUpdate.Res.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_typedb_protocol_ClusterUserManager_Delete_Req(arg) {
  if (!(arg instanceof cluster_cluster_user_pb.ClusterUserManager.Delete.Req)) {
    throw new Error('Expected argument of type typedb.protocol.ClusterUserManager.Delete.Req');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_typedb_protocol_ClusterUserManager_Delete_Req(buffer_arg) {
  return cluster_cluster_user_pb.ClusterUserManager.Delete.Req.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_typedb_protocol_ClusterUserManager_Delete_Res(arg) {
  if (!(arg instanceof cluster_cluster_user_pb.ClusterUserManager.Delete.Res)) {
    throw new Error('Expected argument of type typedb.protocol.ClusterUserManager.Delete.Res');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_typedb_protocol_ClusterUserManager_Delete_Res(buffer_arg) {
  return cluster_cluster_user_pb.ClusterUserManager.Delete.Res.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_typedb_protocol_ClusterUserManager_Get_Req(arg) {
  if (!(arg instanceof cluster_cluster_user_pb.ClusterUserManager.Get.Req)) {
    throw new Error('Expected argument of type typedb.protocol.ClusterUserManager.Get.Req');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_typedb_protocol_ClusterUserManager_Get_Req(buffer_arg) {
  return cluster_cluster_user_pb.ClusterUserManager.Get.Req.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_typedb_protocol_ClusterUserManager_Get_Res(arg) {
  if (!(arg instanceof cluster_cluster_user_pb.ClusterUserManager.Get.Res)) {
    throw new Error('Expected argument of type typedb.protocol.ClusterUserManager.Get.Res');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_typedb_protocol_ClusterUserManager_Get_Res(buffer_arg) {
  return cluster_cluster_user_pb.ClusterUserManager.Get.Res.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_typedb_protocol_ClusterUserManager_PasswordSet_Req(arg) {
  if (!(arg instanceof cluster_cluster_user_pb.ClusterUserManager.PasswordSet.Req)) {
    throw new Error('Expected argument of type typedb.protocol.ClusterUserManager.PasswordSet.Req');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_typedb_protocol_ClusterUserManager_PasswordSet_Req(buffer_arg) {
  return cluster_cluster_user_pb.ClusterUserManager.PasswordSet.Req.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_typedb_protocol_ClusterUserManager_PasswordSet_Res(arg) {
  if (!(arg instanceof cluster_cluster_user_pb.ClusterUserManager.PasswordSet.Res)) {
    throw new Error('Expected argument of type typedb.protocol.ClusterUserManager.PasswordSet.Res');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_typedb_protocol_ClusterUserManager_PasswordSet_Res(buffer_arg) {
  return cluster_cluster_user_pb.ClusterUserManager.PasswordSet.Res.deserializeBinary(new Uint8Array(buffer_arg));
}
...
users_contains: {
  ...
  users_delete: {
    path: '/typedb.protocol.TypeDBCluster/users_delete',
    requestStream: false,
    responseStream: false,
    requestType: cluster_cluster_user_pb.ClusterUserManager.Delete.Req,
    responseType: cluster_cluster_user_pb.ClusterUserManager.Delete.Res,
    requestSerialize: serialize_typedb_protocol_ClusterUserManager_Delete_Req,
    requestDeserialize: deserialize_typedb_protocol_ClusterUserManager_Delete_Req,
    responseSerialize: serialize_typedb_protocol_ClusterUserManager_Delete_Res,
    responseDeserialize: deserialize_typedb_protocol_ClusterUserManager_Delete_Res,
  },
  users_all: {
  ...
  users_password_set: {
    path: '/typedb.protocol.TypeDBCluster/users_password_set',
    requestStream: false,
    responseStream: false,
    requestType: cluster_cluster_user_pb.ClusterUserManager.PasswordSet.Req,
    responseType: cluster_cluster_user_pb.ClusterUserManager.PasswordSet.Res,
    requestSerialize: serialize_typedb_protocol_ClusterUserManager_PasswordSet_Req,
    requestDeserialize: deserialize_typedb_protocol_ClusterUserManager_PasswordSet_Req,
    responseSerialize: serialize_typedb_protocol_ClusterUserManager_PasswordSet_Res,
    responseDeserialize: deserialize_typedb_protocol_ClusterUserManager_PasswordSet_Res,
  },
  users_get: {
    path: '/typedb.protocol.TypeDBCluster/users_get',
    requestStream: false,
    responseStream: false,
    requestType: cluster_cluster_user_pb.ClusterUserManager.Get.Req,
    responseType: cluster_cluster_user_pb.ClusterUserManager.Get.Res,
    requestSerialize: serialize_typedb_protocol_ClusterUserManager_Get_Req,
    requestDeserialize: deserialize_typedb_protocol_ClusterUserManager_Get_Req,
    responseSerialize: serialize_typedb_protocol_ClusterUserManager_Get_Res,
    responseDeserialize: deserialize_typedb_protocol_ClusterUserManager_Get_Res,
  },
  // User API
user_password_update: {
    path: '/typedb.protocol.TypeDBCluster/user_password_update',
    requestStream: false,
    responseStream: false,
    requestType: cluster_cluster_user_pb.ClusterUser.PasswordUpdate.Req,
    responseType: cluster_cluster_user_pb.ClusterUser.PasswordUpdate.Res,
    requestSerialize: serialize_typedb_protocol_ClusterUser_PasswordUpdate_Req,
    requestDeserialize: deserialize_typedb_protocol_ClusterUser_PasswordUpdate_Req,
    responseSerialize: serialize_typedb_protocol_ClusterUser_PasswordUpdate_Res,
    responseDeserialize: deserialize_typedb_protocol_ClusterUser_PasswordUpdate_Res,
  },
  user_token: {
