...
class ThingTypeImpl extends dependencies_internal_1.TypeImpl {
    constructor(name, root, abstract) {
        super(Label_1.Label.of(name), root, abstract);
    }
    get className() {
        return "ThingType";
    }
    asRemote(transaction) {
        return new ThingTypeImpl.Remote(transaction, this.label, this.root, this.abstract);
    }
    isThingType() {
        return true;
    }
...
(function (ThingTypeImpl) {
    ...
    class Remote extends dependencies_internal_1.TypeImpl.Remote {
        ...
        async getSyntax() {
            const request = RequestBuilder_1.RequestBuilder.Type.ThingType.getSyntaxReq(this.label);
