...
(function (RequestBuilder) {
    ...
    (function (Cluster) {
        ...
        (function (UserManager) {
            ...
            function deleteReq(name) {
                return new cluster_user_pb_1.ClusterUserManager.Delete.Req().setUsername(name);
            }
            UserManager.deleteReq = deleteReq;
            function allReq() {
                return new cluster_user_pb_1.ClusterUserManager.All.Req();
            }
            UserManager.allReq = allReq;
            function passwordSetReq(name, password) {
                return new cluster_user_pb_1.ClusterUserManager.PasswordSet.Req().setUsername(name).setPassword(password);
            }
            UserManager.passwordSetReq = passwordSetReq;
            function getReq(name) {
                return new cluster_user_pb_1.ClusterUserManager.Get.Req().setUsername(name);
            }
            UserManager.getReq = getReq;
        })(UserManager = Cluster.UserManager || (Cluster.UserManager = {}));
        let User;
        (function (User) {
            function passwordUpdateReq(name, passwordOld, passwordNew) {
                return new cluster_user_pb_1.ClusterUser.PasswordUpdate.Req().setUsername(name).setPasswordOld(passwordOld).setPasswordNew(passwordNew);
            }
            User.passwordUpdateReq = passwordUpdateReq;
    ...
    (function (Type) {
        ...
        (function (RoleType) {
            ...
            function getPlayerTypesReq(label) {
                return typeReq(newReqBuilder(label).setRoleTypeGetPlayerTypesReq(new concept_pb_1.RoleType.GetPlayerTypes.Req()));
            }
            RoleType.getPlayerTypesReq = getPlayerTypesReq;
            function getPlayerTypesExplicitReq(label) {
                return typeReq(newReqBuilder(label).setRoleTypeGetPlayerTypesExplicitReq(new concept_pb_1.RoleType.GetPlayerTypesExplicit.Req()));
            }
            RoleType.getPlayerTypesExplicitReq = getPlayerTypesExplicitReq;
            function getRelationInstancesReq(label) {
                return typeReq(newReqBuilder(label).setRoleTypeGetRelationInstancesReq(new concept_pb_1.RoleType.GetRelationInstances.Req()));
            }
            RoleType.getRelationInstancesReq = getRelationInstancesReq;
            function getRelationInstancesExplicitReq(label) {
                return typeReq(newReqBuilder(label).setRoleTypeGetRelationInstancesExplicitReq(new concept_pb_1.RoleType.GetRelationInstancesExplicit.Req()));
            }
            RoleType.getRelationInstancesExplicitReq = getRelationInstancesExplicitReq;
            function getPlayerInstancesReq(label) {
                return typeReq(newReqBuilder(label).setRoleTypeGetPlayerInstancesReq(new concept_pb_1.RoleType.GetPlayerInstances.Req()));
            }
            RoleType.getPlayerInstancesReq = getPlayerInstancesReq;
            function getPlayerInstancesExplicitReq(label) {
                return typeReq(newReqBuilder(label).setRoleTypeGetPlayerInstancesExplicitReq(new concept_pb_1.RoleType.GetPlayerInstancesExplicit.Req()));
            }
            RoleType.getPlayerInstancesExplicitReq = getPlayerInstancesExplicitReq;
        ...
        (function (ThingType) {
            ...
            function getSyntaxReq(label) {
                return typeReq(newReqBuilder(label).setThingTypeGetSyntaxReq(new concept_pb_1.ThingType.GetSyntax.Req()));
            }
            ThingType.getSyntaxReq = getSyntaxReq;
